...
class PlayList {
    ...
    public String toString() {
        ...
        for(int i = 0; i<this.size; i++){
            stb.append(this.tracks[i].toString()).append("\n");
        }
        return stb.toString();
    }
    ...
    public int totalDuration() {
        int sumSeconds=0;
        for (int i = 0 ;i<this.size ;i++){
            sumSeconds+= this.tracks[i].getDuration();
        }
        return sumSeconds;
    }
    ...
    private int minIndex(int start) {
        ...
        int minIndex = start;
        int minTime = this.tracks[start].getDuration();
        for(int i = start; i<this.size;i++){
            if(this.tracks[i].getDuration()<minTime){
                minTime =this.tracks[i].getDuration();
                minIndex=i;
            }
        }
        return minIndex;
